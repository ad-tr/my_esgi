...
import { HiOutlineHome, HiOutlineDatabase, HiOutlineBookmark, HiOutlineChat, HiOutlineCog } from "react-icons/hi";
            ...
            <div className="relative flex flex-col w-full h-full rounded-2xl bg-slate-50 p-5 justify-between">
                    ...
                    <div className="mt-44">
                        <ul className="flex flex-col gap-6">
                            <Link href="/posts" className="flex items-center gap-3 hover:text-[#4074F8] active:hover:text-[#b0c7ff]">
                                ...
                                <p className="font-[family-name:var(--font-geist-sans)] text-base font-semibold">Accueil</p>
                            </Link>
                            <Link href="/location" className="flex items-center gap-3 hover:text-[#4074F8] active:hover:text-[#b0c7ff]">
                                ...
                                <p className="font-[family-name:var(--font-geist-sans)] text-base font-semibold">Location</p>
                            </Link>
                            <Link href="/favoris" className="flex items-center gap-3 hover:text-[#4074F8] active:hover:text-[#b0c7ff]">
                                ...
                                <p className="font-[family-name:var(--font-geist-sans)] text-base font-semibold">Favoris</p>
                            </Link>
                            <Link href="/publications" className="flex items-center gap-3 hover:text-[#4074F8] active:hover:text-[#b0c7ff]">
                                ...
                                <p className="font-[family-name:var(--font-geist-sans)] text-base font-semibold">Mes posts</p>
                            </Link>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <Link href="/parametres" className="flex items-center gap-3 hover:text-[#4074F8] active:hover:text-[#b0c7ff]">
                        ...
                        <p className="font-[family-name:var(--font-geist-sans)] text-base font-semibold">Parametres</p>
                    </Link>
                </div>
            </div>
        </div>
